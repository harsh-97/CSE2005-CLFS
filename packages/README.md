...
Libcap (2.24) - 68 KB:
    ...
    Download: http://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.24.tar.xz
...
Systemd (213) - 2,783 KB:

    Home page: http://freedesktop.org/wiki/Software/systemd

    Download: http://www.freedesktop.org/software/systemd/systemd-213.tar.xz

    MD5 sum: 06496edcf86ddf6d8c12d72ba78e735d
Tar (1.27.1) - 1,880 KB:
...
XML::Parser (2.42_01) - 240 KB:

    Home page: https://github.com/chorny/XML-Parser

    Download: http://search.cpan.org/CPAN/authors/id/T/TO/TODDR/XML-Parser-2.42_01.tar.gz

    MD5 sum: a4650aebcc464bb91113c2c356da8210
